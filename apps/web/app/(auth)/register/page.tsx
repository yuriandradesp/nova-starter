    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-950 px-4">
      <div className="w-full max-w-md p-8 sm:p-10 bg-zinc-900 rounded-2xl shadow-2xl border border-zinc-800/80">
        <div className="mb-8 text-center">
          ...
          <p className="text-zinc-400 mt-2 text-sm">Join Nova to manage your workspaces</p>
        </div>
        ...
        <p className="mt-8 text-sm text-center text-zinc-500">
          ...
          <Link href="/login" className="font-medium text-zinc-300 hover:text-zinc-100 transition-colors">
            Sign in
          </Link>
        </p>
      </div>
